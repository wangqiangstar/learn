...
![img](https://user-gold-cdn.xitu.io/2020/3/14/170d948bfea2c89e?w=914&h=323&f=png&s=10923)
...
例如，让我们回想一下 `delay(f, ms)` 装饰器，它是我们在 [装饰者模式，call/apply ](https://juejin.im/post/5e6c8870f265da574f355681)一章中完成的。
...
就是说，一切都很简单：如果钩子想要将调用转发给对象，则只需使用相同的参数调用 `Reflect.` 就足够了。
