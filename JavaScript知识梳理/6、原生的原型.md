...
![img](https://user-gold-cdn.xitu.io/2020/3/16/170e33f62c2d5ba3?w=822&h=188&f=png&s=10312)

当 `new Object()` 被调用（或一个字面量对象 `{...}` 被创建），按照前面章节中我们学习过的规则，这个对象的 `[[Prototype]]` 属性被设置为 `Object.prototype`：

![img](https://user-gold-cdn.xitu.io/2020/3/16/170e33fe596da2e2?w=866&h=347&f=png&s=16926)
...
![img](https://user-gold-cdn.xitu.io/2020/3/16/170e3408b3353fc6?w=1187&h=647&f=png&s=47515)
...
![img](https://user-gold-cdn.xitu.io/2020/3/16/170e341213491bd3?w=746&h=520&f=png&s=16762)

浏览器内的工具，像 Chrome 开发者控制台也会显示继承性（可能需要对内置对象使用 `console.dir`）：

![img](https://user-gold-cdn.xitu.io/2020/3/16/170e33cae137a43a?w=567&h=292&f=png&s=17005)
...
在 [装饰者模式，call/apply](https://juejin.im/post/5e6c8870f265da574f355681) 一章中，我们讨论了方法借用。
