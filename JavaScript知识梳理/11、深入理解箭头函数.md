...
正如我们在 [对象方法，"this"](https://juejin.im/post/5e7377d9e51d452712106b7a) 一章中所学到的，箭头函数没有 `this`。如果访问 `this`，则会从外部获取。
...
- 没有 `arguments`
- 不能使用 `new` 进行调用
- 它们也没有 `super`，但目前我们还没有学到它。我们将在 [类继承](https://juejin.im/post/5e720d0f518825496f3840c9) 一章中学习它。
