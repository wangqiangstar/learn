...
![img](http://cdn.semlinker.com/intersection-type-xy-err.jpg)

```
q = { c: "c", d: "d", e: "e" };
```

![img](http://cdn.semlinker.com/intersection-type-yx-err.jpg)
...
![img](http://cdn.semlinker.com/intersection-type-non-primitive.jpg)
