[TypeScript](https://www.typescriptlang.org/) 是一种由微软开发的自由和开源的编程语言。它是 JavaScript 的一个超集，而且本质上向这个语言添加了可选的静态类型和基于类的面向对象编程。本文将分享编写高效 TS 代码的 5 个建议，希望这些建议对大家编写 TS 代码能有一些帮助。
